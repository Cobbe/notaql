...
import notaql.model.path.AnyBoundStep;
import notaql.model.path.CurrentBoundStep;
import notaql.model.path.IdStep;
import notaql.model.path.IndexPathMethodStep;
import notaql.model.path.InputPathStep;
import notaql.model.path.NamePathMethodStep;
import notaql.model.path.PredicateStep;
import notaql.model.path.ResolvedIdStep;
import notaql.model.path.StringSplitMethodStep;
...
public class ElasticsearchInputPathStepVisitor extends NotaQL2DocumentInBaseVisitor<InputPathStep> {
	...
	public ElasticsearchInputPathStepVisitor(TransformationParser parser) {
		this.parser = parser;
	}
